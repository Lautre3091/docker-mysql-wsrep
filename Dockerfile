...
# Information
MAINTAINER Gweltaz GESTIN <gestin.gweltaz@gmail.com>
LABEL Description="This image is used to stand up a MySQL wsrep instance." Version="5.6.42-25.24"
...
ENV MSW_PKG_VRS 5.6.42-25.24-1trusty
